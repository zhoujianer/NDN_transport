...
\{zhoujianer, wuqinghua, wangyonggong, zyli, xieg\}@ict.ac.cn}
...
The future work will be focused on the theory proven of the system stability. In NDN, as the in-network cache, a Data will have serval providers. That will influence the ECN information carried by Data and the RTT. We want to analysis what would happen on such situation and how to make effective resolution for this.
